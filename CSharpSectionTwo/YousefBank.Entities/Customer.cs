...
using YousefBank.Entities.Contracts;
using YousefBank.Eceptions;

namespace YousefBank.Entities
{
    /// <summary>
    ...
    public class Customer : ICustomer
    {
        ...
        public string Lndmark { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
